...
<form action="<?php echo base_url('time/inserir'); ?>" method="post" enctype="multipart/form-data">
  <div class="row">
    <div class="col-lg-6">
    ...
    <div class="col-lg-4 text-center">
      <div>
        <img alt="Logo do time" id="uploadPreview" width="150px" height="150px" src="<?php echo base_url('assets/img/teams/team.png'); ?>" class="img-circle">
        <br><br>
